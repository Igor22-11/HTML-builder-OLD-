...
- [ ] При выполнении команды `node 03-files-in-folder` в корневом каталоге репозитория в консоль выводится информация о файлах содержащихся внутри **_03-files-in-folder/secret-folder_**. Данные должны быть выведены в формате <имя файла>-<расширение файла>-<вес файла кб>. Пример: `example - txt - 128kb`
